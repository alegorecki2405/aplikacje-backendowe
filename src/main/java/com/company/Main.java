...
public class Main {
    ...
    public static void zadanieSzoste() throws IOException {
        ...
        try {
            reader = new BufferedReader(new FileReader("D:\\SPRING\\studia\\input"));
    ...
    public static void zadaniePierwsze() throws IOException {
        ...
        try (FileInputStream in = new FileInputStream("D:\\SPRING\\studia\\input")) {
            String str = "xd";
    ...
    public static void zadanieDrugie() throws IOException {
        String fileName = "D:\\SPRING\\studia\\output.txt";
